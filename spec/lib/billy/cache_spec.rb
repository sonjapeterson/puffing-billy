  ...
  describe 'format_url' do
    ...
    context 'with cache_request_body_methods set' do
      ...
      context "for requests with methods specified in cache_request_body_methods" do
        it "should have a different cache key for requests with different bodies or methods" do
      ...
      it "should have the same cache key for request with different bodies if their methods are not included cache_request_body_methods" do
